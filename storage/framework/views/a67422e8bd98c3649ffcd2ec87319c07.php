...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="#" class="nav-item" data-section="all-enquiries" onclick="showSection('all-enquiries',this)">
            ...
            All Enquiries
            <span class="nav-badge"><?php echo e($totalEnquiries); ?></span>
        </a>
        ...
        <a href="#" class="nav-item" data-section="resolved" onclick="showSection('resolved',this)">
            ...
            Approved
            <span class="nav-badge info"><?php echo e($resolvedCount); ?></span>
        </a>
...
<header class="topbar">
    <div class="topbar-left">
        ...
        <p><?php echo e(\Carbon\Carbon::now()->format('l, d F Y')); ?></p>
    </div>
    <div class="topbar-right">
        ...
        <div class="user-badge">
            ...
            <div class="user-info">
                <div class="u-name"><?php echo e(auth()->user()->name); ?></div>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-value"><?php echo e($totalEnquiries); ?></div>
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-value"><?php echo e($bookingCount); ?></div>
            </div>
        </div>
        <div class="stat-card">
    ...
    <div class="modules-grid" style="margin-bottom:28px;">
        ...
        <a href="#" class="module-card" style="--card-accent:#1e3052;" onclick="showSection('mod-booking', document.querySelector('[data-section=mod-booking]')); return false;">
            ...
            <div class="module-card-footer">
                <span class="module-card-count"><?php echo e($bookingCount); ?></span>
        ...
        <a href="#" class="module-card" style="--card-accent:#f59e0b;" onclick="showSection('mod-maintenance', document.querySelector('[data-section=mod-maintenance]')); return false;">
            ...
            <div class="module-card-footer">
                <span class="module-card-count" style="color:#f59e0b;"><?php echo e($maintCount); ?></span>
                <span class="module-card-arrow"><i class="fas fa-arrow-right"></i></span>
            </div>
        </a>
        ...
        <a href="#" class="module-card" style="--card-accent:#3db87a;" onclick="showSection('mod-billing', document.querySelector('[data-section=mod-billing]')); return false;">
            ...
            <div class="module-card-footer">
                <span class="module-card-count" style="color:#3db87a;"><?php echo e($billingCount); ?></span>
                <span class="module-card-arrow"><i class="fas fa-arrow-right"></i></span>
            </div>
        </a>
        ...
        <a href="#" class="module-card" style="--card-accent:#3b82f6;" onclick="showSection('mod-insurance', document.querySelector('[data-section=mod-insurance]')); return false;">
            ...
            <div class="module-card-footer">
                <span class="module-card-count" style="color:#3b82f6;"><?php echo e($taxCount+$insuranceCount); ?></span>
                <span class="module-card-arrow"><i class="fas fa-arrow-right"></i></span>
            </div>
        </a>
        ...
        <a href="#" class="module-card" style="--card-accent:#c9a84c;" onclick="showSection('mod-reports', document.querySelector('[data-section=mod-reports]')); return false;">
            ...
            <div class="module-card-footer">
                <span class="module-card-count" style="color:#c9a84c;"><?php echo e($totalEnquiries); ?></span>
                <span class="module-card-arrow"><i class="fas fa-arrow-right"></i></span>
            </div>
        </a>
            ...
            <div style="overflow-x:auto;">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div style="font-weight:600; font-size:13px;"><?php echo e($enq->name); ?></div>
                                <div style="font-size:11px; color:var(--text-muted);"><?php echo e($enq->mobile); ?></div>
                            </td>
                            <td>
                                <?php
                                ...
                                ?>
                                <span class="badge <?php echo e($cls); ?>"><?php echo e($enq->type_of_enquiry); ?></span>
                            </td>
                            <td style="font-size:12px; color:var(--text-muted);">
                                <?php echo e($enq->date_of_requirement ? \Carbon\Carbon::parse($enq->date_of_requirement)->format('d M Y') : '—'); ?>

                            </td>
                            <td>
                                <span class="badge <?php echo e($enq->status=='approved' ? 'b-approved' : 'b-pending'); ?>">
                                    <?php echo e(ucfirst($enq->status ?? 'pending')); ?>

                                </span>
                            </td>
                            <td>
                                <button class="action-btn btn-view" onclick="openEnquiryModal(<?php echo e($enq->id); ?>)">
        ...
        <div style="display:flex; flex-direction:column; gap:20px;">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    ?>
                    <?php $__currentLoopData = $breakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mini-stat">
                        <div class="mini-stat-label">
                            <span class="dot" style="background:<?php echo e($dotColors[$i]); ?>"></span>
                            <?php echo e($item['label']); ?>

                        </div>
                        <div class="mini-stat-val"><?php echo e($item['count']); ?></div>
                    </div>
                    <div class="progress-wrap" style="margin-bottom:10px;">
                        <div class="progress-bar">
                            <div class="progress-fill" style="width:<?php echo e($item['pct']); ?>%; background:linear-gradient(90deg,<?php echo e($dotColors[$i]); ?>,<?php echo e($dotColors[$i]); ?>aa);"></div>
                        </div>
                    </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body" style="padding-top:10px;">
                    <div class="activity-list">
                        <?php $__currentLoopData = $recentEnquiries->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="activity-item">
                            ...
                            <div>
                                <div class="act-text">
                                    <strong><?php echo e($enq->name); ?></strong> submitted a
                                    <strong><?php echo e($enq->type_of_enquiry); ?></strong> enquiry
                                </div>
                                <div class="act-time"><?php echo e($enq->created_at->diffForHumans()); ?></div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
    ...
    <div class="three-col">
        <div class="panel">
            ...
            <div class="panel-body" style="text-align:center; padding:28px;">
                <div style="font-size:42px; font-weight:800; color:var(--navy); font-family:'Playfair Display',serif;"><?php echo e($todayCount); ?></div>
        ...
        <div class="panel">
            ...
            <div class="panel-body" style="text-align:center; padding:28px;">
                <div style="font-size:42px; font-weight:800; color:var(--success); font-family:'Playfair Display',serif;">
                    <?php echo e($totalEnquiries ? round($resolvedCount/$totalEnquiries*100) : 0); ?>%
                </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body" style="text-align:center; padding:28px;">
                <div style="font-size:32px; font-weight:800; color:var(--warning); font-family:'Playfair Display',serif;">
                    ₹<?php echo e(number_format($totalMaintenanceCost, 0)); ?>

                </div>
                <div style="font-size:12px; color:var(--text-muted); margin-top:6px;">Across <?php echo e($maintCount); ?> service records</div>
            </div>
        </div>
    </div>
...
<div id="section-all-enquiries" class="section-content" style="display:none;">
    <div class="panel">
        <div class="panel-header">
            ...
            <a href="<?php echo e(route('travels.export')); ?>" class="btn-outline">
        ...
        <div style="overflow-x:auto;">
            <table class="data-table" id="tblAll">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $allEnquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr data-type="<?php echo e($enq->type_of_enquiry); ?>" data-status="<?php echo e($enq->status ?? 'pending'); ?>">
                        <td style="color:var(--text-muted); font-weight:600;"><?php echo e($i+1); ?></td>
                        <td>
                            <div style="font-weight:600;"><?php echo e($enq->name); ?></div>
                            <div style="font-size:11px; color:var(--text-muted);"><?php echo e($enq->user->email ?? '—'); ?></div>
                        </td>
                        <td><?php echo e($enq->mobile); ?></td>
                        <td style="max-width:140px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;" title="<?php echo e($enq->address); ?>"><?php echo e($enq->address); ?></td>
                        <td><span class="badge <?php echo e(['Bus Booking'=>'b-bus','Sleeper Coach Booking'=>'b-sleeper','Package Tours'=>'b-package','Bus Rental'=>'b-rental'][$enq->type_of_enquiry]??'b-bus'); ?>"><?php echo e($enq->type_of_enquiry); ?></span></td>
                        <td style="font-size:12px; color:var(--text-muted);"><?php echo e($enq->date_of_requirement ? \Carbon\Carbon::parse($enq->date_of_requirement)->format('d M Y') : '—'); ?></td>
                        <td style="font-size:12px; color:var(--text-muted);"><?php echo e($enq->created_at->format('d M Y')); ?></td>
                        <td><span class="badge <?php echo e($enq->status=='approved'?'b-approved':'b-pending'); ?>"><?php echo e(($enq->status=='approved' ? 'Approved' : ucfirst($enq->status??'pending'))); ?></span></td>
                        <td>
                            <div style="display:flex; gap:5px; flex-wrap:nowrap;">
                                <button class="action-btn btn-view" onclick="openEnquiryModal(<?php echo e($enq->id); ?>)" title="View"><i class="fas fa-eye"></i></button>
                                <?php if(($enq->status ?? 'pending') === 'pending'): ?>
                                <form action="<?php echo e(route('manager.enquiry.resolve', $enq->id)); ?>" method="POST" style="margin:0;">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                    <button type="submit" class="action-btn btn-resolve" title="Approve"><i class="fas fa-check"></i></button>
                                </form>
                                <?php endif; ?>
                                <form action="<?php echo e(route('manager.enquiry.destroy', $enq->id)); ?>" method="POST" style="margin:0;" onsubmit="return confirm('Delete this enquiry?')">
        ...
        <div class="panel-footer"><?php echo e($allEnquiries->links()); ?></div>
    </div>
</div>
...
<div id="section-pending" class="section-content" style="display:none;">
    <div class="panel">
        <div class="panel-header"><div><h2>Pending Enquiries</h2><p><?php echo e($pendingCount); ?> awaiting response</p></div></div>
        <div style="overflow-x:auto;">
            <table class="data-table">
                <thead><tr><th>#</th><th>Name</th><th>Mobile</th><th>Type</th><th>Date Req.</th><th>Submitted</th><th>Action</th></tr></thead>
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $allEnquiries->getCollection()->where('status','pending'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td style="color:var(--text-muted); font-weight:600;"><?php echo e($i+1); ?></td>
                        <td><div style="font-weight:600;"><?php echo e($enq->name); ?></div></td>
                        <td><?php echo e($enq->mobile); ?></td>
                        <td><span class="badge <?php echo e(['Bus Booking'=>'b-bus','Sleeper Coach Booking'=>'b-sleeper','Package Tours'=>'b-package','Bus Rental'=>'b-rental'][$enq->type_of_enquiry]??'b-bus'); ?>"><?php echo e($enq->type_of_enquiry); ?></span></td>
                        <td style="font-size:12px; color:var(--text-muted);"><?php echo e($enq->date_of_requirement ? \Carbon\Carbon::parse($enq->date_of_requirement)->format('d M Y') : '—'); ?></td>
                        <td style="font-size:12px; color:var(--text-muted);"><?php echo e($enq->created_at->format('d M Y')); ?></td>
                        <td>
                            <div style="display:flex; gap:5px;">
                                <button class="action-btn btn-view" onclick="openEnquiryModal(<?php echo e($enq->id); ?>)"><i class="fas fa-eye"></i></button>
                                <form action="<?php echo e(route('manager.enquiry.resolve', $enq->id)); ?>" method="POST" style="margin:0;">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
...
<div id="section-resolved" class="section-content" style="display:none;">
    <div class="panel">
        <div class="panel-header"><div><h2>Approved Enquiries</h2><p><?php echo e($resolvedCount); ?> approved</p></div></div>
        <div style="overflow-x:auto;">
            <table class="data-table">
                <thead><tr><th>#</th><th>Name</th><th>Mobile</th><th>Type</th><th>Date Req.</th><th>Submitted</th><th>Status</th></tr></thead>
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $allEnquiries->getCollection()->where('status','approved'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td style="color:var(--text-muted); font-weight:600;"><?php echo e($i+1); ?></td>
                        <td><div style="font-weight:600;"><?php echo e($enq->name); ?></div></td>
                        <td><?php echo e($enq->mobile); ?></td>
...
]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$sid, $type, $icon, $badgeCls]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div id="section-<?php echo e($sid); ?>" class="section-content" style="display:none;">
    <div class="panel">
        <div class="panel-header">
            <div>
                <h2><i class="fas <?php echo e($icon); ?>" style="color:var(--gold);margin-right:8px;"></i><?php echo e($type); ?></h2>
        ...
        <div style="overflow-x:auto;">
            <table class="data-table">
                ...
                <tbody>
                    <?php $filtered = $allEnquiries->getCollection()->where('type_of_enquiry', $type); $idx=1; ?>
                    <?php $__empty_1 = true; $__currentLoopData = $filtered; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td style="color:var(--text-muted); font-weight:600;"><?php echo e($idx++); ?></td>
                        <td><div style="font-weight:600;"><?php echo e($enq->name); ?></div></td>
                        <td><?php echo e($enq->mobile); ?></td>
                        <td style="max-width:130px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;"><?php echo e($enq->address); ?></td>
                        <td style="font-size:12px; color:var(--text-muted);"><?php echo e($enq->date_of_requirement ? \Carbon\Carbon::parse($enq->date_of_requirement)->format('d M Y') : '—'); ?></td>
                        <td style="font-size:12px; color:var(--text-muted);"><?php echo e($enq->created_at->format('d M Y')); ?></td>
                        <td><span class="badge <?php echo e($enq->status=='approved'?'b-approved':'b-pending'); ?>"><?php echo e(($enq->status=='approved' ? 'Approved' : ucfirst($enq->status??'pending'))); ?></span></td>
                        <td>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr><td colspan="8"><div class="empty-state"><i class="fas fa-inbox"></i><p>No <?php echo e($type); ?> enquiries found.</p></div></td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
...
<div id="section-mod-booking" class="section-content" style="display:none;">
    <div class="panel" style="margin-bottom:22px;">
        <div class="panel-header">
            ...
            <div style="display:flex; gap:8px; align-items:center;">
                <span class="badge b-bus">Bus: <?php echo e($busCount); ?></span>
                <span class="badge b-sleeper">Sleeper: <?php echo e($sleeperCount); ?></span>
            </div>
        </div>
        <div style="overflow-x:auto;">
            <table class="data-table">
                ...
                <tbody>
                    <?php
                        ...
                        $bidx = 1;
                    ?>
                    <?php $__empty_1 = true; $__currentLoopData = $bookingEnquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td style="color:var(--text-muted); font-weight:600;"><?php echo e($bidx++); ?></td>
                        <td><div style="font-weight:600;"><?php echo e($enq->name); ?></div><div style="font-size:11px;color:var(--text-muted);"><?php echo e($enq->mobile); ?></div></td>
                        <td><?php echo e($enq->mobile); ?></td>
                        <td style="max-width:130px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"><?php echo e($enq->address); ?></td>
                        <td><span class="badge <?php echo e($enq->type_of_enquiry=='Bus Booking'?'b-bus':'b-sleeper'); ?>"><?php echo e($enq->type_of_enquiry); ?></span></td>
                        <td style="font-size:12px;color:var(--text-muted);"><?php echo e($enq->date_of_requirement ? \Carbon\Carbon::parse($enq->date_of_requirement)->format('d M Y') : '—'); ?></td>
                        <td style="font-size:12px;color:var(--text-muted);"><?php echo e($enq->created_at->format('d M Y')); ?></td>
                        <td><span class="badge <?php echo e($enq->status=='approved'?'b-approved':'b-pending'); ?>"><?php echo e($enq->status=='approved'?'Approved':ucfirst($enq->status??'pending')); ?></span></td>
                        <td>
                            <div style="display:flex;gap:5px;">
                                <button class="action-btn btn-view" onclick="openEnquiryModal(<?php echo e($enq->id); ?>)"><i class="fas fa-eye"></i></button>
                                <?php if(($enq->status??'pending')!=='approved'): ?>
                                <form action="<?php echo e(route('manager.enquiry.resolve', $enq->id)); ?>" method="POST" style="margin:0;">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                    <button type="submit" class="action-btn btn-resolve"><i class="fas fa-check"></i> Approve</button>
                                </form>
    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <div style="display:flex; gap:8px; align-items:center;">
                <a href="<?php echo e(route('manager.booking.export.pdf')); ?>" target="_blank"
                ...
                <a href="<?php echo e(route('manager.booking.print')); ?>" target="_blank"
        ...
        <div style="margin:16px 22px 0; background:rgba(61,184,122,.1); border:1px solid rgba(61,184,122,.3); color:#166534; padding:12px 16px; border-radius:9px; font-size:13px; display:flex; align-items:center; gap:8px;">
            <i class="fas fa-circle-check"></i> <?php echo e(session('booking_success')); ?>

        </div>
        <?php endif; ?>

        <?php if($errors->hasBag('booking')): ?>
        <div style="margin:16px 22px 0; background:rgba(224,85,85,.08); border:1px solid rgba(224,85,85,.25); color:var(--danger); padding:12px 16px; border-radius:9px; font-size:13px;">
            ...
            <?php $__currentLoopData = $errors->getBag('booking')->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="font-size:12px;">• <?php echo e($err); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php endif; ?>
        ...
        <div style="overflow-x:auto;">
            <table class="data-table" id="tblBookings">
                ...
                <tbody id="bkTbody">
                    <?php $__empty_1 = true; $__currentLoopData = $busBookings ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $bkDate   = \Carbon\Carbon::parse($booking->booking_date)->format('Y-m-d');
                        $bkPickup = \Carbon\Carbon::parse($booking->pickup_time)->format('H:i');
                    ?>
                    <tr class="bk-row"
                        data-date="<?php echo e($bkDate); ?>"
                        data-bus="<?php echo e(strtolower($booking->bus_number)); ?>"
                        data-route="<?php echo e(strtolower($booking->route_from . ' ' . $booking->route_to)); ?>"
                        data-km="<?php echo e($booking->kilometer); ?>"
                        data-amount="<?php echo e($booking->booking_amount); ?>"
                        data-advance="<?php echo e($booking->advance_amount); ?>"
                        data-balance="<?php echo e($booking->remaining_amount); ?>"
                        data-pickup="<?php echo e($bkPickup); ?>"
                        data-note="<?php echo e(strtolower($booking->note ?? '')); ?>">
                        <td class="bk-num" style="color:var(--text-muted); font-weight:600;"><?php echo e($i + 1); ?></td>
                        ...
                        <td>
                            <div style="display:flex; align-items:center; gap:6px; font-size:13px;">
                                <span style="font-weight:600; color:var(--navy);"><?php echo e($booking->route_from); ?></span>
                                <i class="fas fa-arrow-right" style="color:var(--gold); font-size:10px;"></i>
                                <span style="font-weight:600; color:var(--navy);"><?php echo e($booking->route_to); ?></span>
                            </div>
                        </td>
                        <td><span style="background:rgba(201,168,76,.1); color:#8a6a15; padding:3px 10px; border-radius:6px; font-size:12px; font-weight:700;"><?php echo e($booking->kilometer); ?> km</span></td>
                        <td><span style="background:rgba(30,48,82,.08); color:var(--navy-mid); padding:3px 10px; border-radius:6px; font-size:12px; font-weight:700;"><?php echo e($booking->bus_number); ?></span></td>
                        <td style="font-weight:700; color:var(--navy);">₹<?php echo e(number_format($booking->booking_amount, 2)); ?></td>
                        <td style="font-weight:600; color:var(--success);">₹<?php echo e(number_format($booking->advance_amount, 2)); ?></td>
                        <td style="font-weight:700; color:<?php echo e($booking->remaining_amount > 0 ? 'var(--danger)' : 'var(--success)'); ?>;">₹<?php echo e(number_format($booking->remaining_amount, 2)); ?></td>
                        <td style="font-size:13px; white-space:nowrap;">
                            <i class="fas fa-clock" style="color:var(--gold); font-size:11px; margin-right:3px;"></i>
                            <?php echo e(\Carbon\Carbon::parse($booking->pickup_time)->format('h:i A')); ?>

                        </td>
                        <td style="font-size:12px; color:var(--text-muted); max-width:120px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;" title="<?php echo e($booking->note); ?>"><?php echo e($booking->note ?? '—'); ?></td>
                        <td>
                            <div style="display:flex; gap:5px;">
                                <button type="button" class="action-btn btn-edit" title="Edit"
                                    onclick="openEditBookingModal(
                                        <?php echo e($booking->id); ?>,
                                        '<?php echo e($booking->booking_date instanceof \Carbon\Carbon ? $booking->booking_date->format('Y-m-d') : \Carbon\Carbon::parse($booking->booking_date)->format('Y-m-d')); ?>',
                                        <?php echo e(json_encode($booking->route_from)); ?>,
                                        <?php echo e(json_encode($booking->route_to)); ?>,
                                        <?php echo e($booking->kilometer); ?>,
                                        <?php echo e(json_encode($booking->bus_number)); ?>,
                                        '<?php echo e(\Carbon\Carbon::parse($booking->pickup_time)->format('H:i')); ?>',
                                        <?php echo e($booking->booking_amount); ?>,
                                        <?php echo e($booking->advance_amount); ?>,
                                        <?php echo e(json_encode($booking->note ?? '')); ?>

                                    )">
                                    <i class="fas fa-pen-to-square"></i>
                                </button>
                                <form action="<?php echo e(route('manager.booking.destroy', $booking->id)); ?>" method="POST" style="margin:0;"
                                    onsubmit="return confirm('Delete booking #<?php echo e($booking->id); ?>?')">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="action-btn btn-delete" title="Delete"><i class="fas fa-trash"></i></button>
                                </form>
                            </div>
        ...
        <?php if(!empty($busBookings) && $busBookings instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
        <div class="panel-footer"><?php echo e($busBookings->links()); ?></div>
        <?php endif; ?>
    </div>
</div>
...
<div id="section-mod-maintenance" class="section-content" style="display:none;">
    ...
    <?php if(session('maintenance_success')): ?>
    <div style="margin-bottom:16px; background:rgba(245,158,11,.1); border:1px solid rgba(245,158,11,.3); color:#92400e; padding:12px 18px; border-radius:10px; font-size:13px; display:flex; align-items:center; gap:8px;">
        <i class="fas fa-circle-check" style="color:var(--warning);"></i> <?php echo e(session('maintenance_success')); ?>
    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <div style="display:flex; gap:8px; align-items:center;">
                ...
                <span style="background:rgba(245,158,11,.1); color:#92400e; padding:7px 14px; border-radius:9px; font-size:13px; font-weight:700;">
                    <i class="fas fa-indian-rupee-sign" style="font-size:11px;"></i> <?php echo e(number_format($totalMaintenanceCost, 2)); ?> total
                </span>
                <a href="<?php echo e(route('manager.maintenance.export.pdf')); ?>" target="_blank"
                   style="background:rgba(224,85,85,.1); color:var(--danger); padding:8px 16px; border-radius:9px; font-size:13px; font-weight:600; text-decoration:none; display:inline-flex; align-items:center; gap:6px;">
                    <i class="fas fa-file-pdf"></i> Export PDF
                </a>
        ...
        <?php if($errors->hasBag('maintenance') && $errors->getBag('maintenance')->any()): ?>
        <div style="margin:16px 22px 0; background:rgba(224,85,85,.08); border:1px solid rgba(224,85,85,.25); color:var(--danger); padding:12px 16px; border-radius:9px; font-size:13px;">
            <div style="font-weight:700; margin-bottom:4px;"><i class="fas fa-triangle-exclamation"></i> Please fix:</div>
            <?php $__currentLoopData = $errors->getBag('maintenance')->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="font-size:12px;">• <?php echo e($err); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php endif; ?>
        ...
        <div style="overflow-x:auto;">
            <table class="data-table" id="tblMaintenance">
                ...
                <tbody id="maintTbody">
                    <?php $__empty_1 = true; $__currentLoopData = $maintenanceRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="maint-row"
                        data-date="<?php echo e($rec->maintenance_date->format('Y-m-d')); ?>"
                        data-bus="<?php echo e(strtolower($rec->bus_number)); ?>"
                        data-type="<?php echo e(strtolower($rec->display_type)); ?>"
                        data-vendor="<?php echo e(strtolower($rec->vendor_name ?? '')); ?>"
                        data-desc="<?php echo e(strtolower($rec->description ?? '')); ?>"
                        data-amount="<?php echo e($rec->amount_paid); ?>">
                        <td class="maint-row-num" style="color:var(--text-muted); font-weight:600;"><?php echo e($i + 1); ?></td>
                        <td style="font-size:13px; white-space:nowrap;">
                            <i class="fas fa-calendar-day" style="color:var(--warning); font-size:11px; margin-right:4px;"></i>
                            <?php echo e($rec->maintenance_date->format('d M Y')); ?>
                        ...
                        <td>
                            <span style="background:rgba(30,48,82,.08); color:var(--navy-mid); padding:3px 10px; border-radius:6px; font-size:12px; font-weight:700;">
                                <?php echo e($rec->bus_number); ?>

                            </span>
                        </td>
                        <td>
                            <span style="background:rgba(245,158,11,.1); color:#92400e; padding:3px 10px; border-radius:6px; font-size:12px; font-weight:600;">
                                <?php echo e($rec->display_type); ?>

                            </span>
                        </td>
                        <td style="font-size:13px;"><?php echo e($rec->vendor_name ?? '—'); ?></td>
                        <td style="font-size:12px; color:var(--text-muted); max-width:160px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;" title="<?php echo e($rec->description); ?>">
                        ...
                        <td style="text-align:center; white-space:nowrap;">
                            <?php if($rec->tier_image): ?>
                                <a href="<?php echo e(Storage::url($rec->tier_image)); ?>" target="_blank" title="View Tier Image"
                            ...
                            <?php endif; ?>
                            <?php if($rec->bill_image): ?>
                                <a href="<?php echo e(Storage::url($rec->bill_image)); ?>" target="_blank" title="View Bill Image"
                            ...
                            <?php endif; ?>
                            <?php if(!$rec->tier_image && !$rec->bill_image): ?>
                                <span style="color:var(--text-muted); font-size:12px;">—</span>
                            <?php endif; ?>
                        </td>

                        <td style="font-weight:700; color:var(--danger); text-align:right;">
                            ₹<?php echo e(number_format($rec->amount_paid, 2)); ?>
                            ...
                            <div style="display:flex; gap:5px;">
                                <button type="button" class="action-btn btn-edit" title="Edit"
                                    onclick="openEditMaintenanceModal(
                                        <?php echo e($rec->id); ?>,
                                        '<?php echo e($rec->maintenance_date->format('Y-m-d')); ?>',
                                        <?php echo e(json_encode($rec->bus_number)); ?>,
                                        <?php echo e(json_encode($rec->maintenance_type)); ?>,
                                        <?php echo e(json_encode($rec->custom_type ?? '')); ?>,
                                        <?php echo e(json_encode($rec->vendor_name ?? '')); ?>,
                                        <?php echo e(json_encode($rec->description ?? '')); ?>,
                                        <?php echo e($rec->amount_paid); ?>,
                                        <?php echo e(json_encode($rec->tier_image ? Storage::url($rec->tier_image) : '')); ?>,
                                        <?php echo e(json_encode($rec->bill_image ? Storage::url($rec->bill_image) : '')); ?>

                                    )">
                                    <i class="fas fa-pen-to-square"></i>
                                </button>
                                <form action="<?php echo e(route('manager.maintenance.destroy', $rec->id)); ?>" method="POST" style="margin:0;"
                                    onsubmit="return confirm('Delete maintenance record #<?php echo e($rec->id); ?>?')">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
        ...
        <?php if($maintenanceRecords instanceof \Illuminate\Pagination\LengthAwarePaginator && $maintenanceRecords->hasPages()): ?>
        <div class="panel-footer"><?php echo e($maintenanceRecords->links()); ?></div>
        <?php endif; ?>
    </div>
</div>
...
<div id="section-mod-billing" class="section-content" style="display:none;">
    ...
    <?php if(session('billing_success')): ?>
    <div style="margin-bottom:16px; background:rgba(61,184,122,.1); border:1px solid rgba(61,184,122,.3); color:#166534; padding:12px 18px; border-radius:10px; font-size:13px; display:flex; align-items:center; gap:8px;">
        <i class="fas fa-circle-check"></i> <?php echo e(session('billing_success')); ?>
    ...
    <div class="panel">
        ...
        <?php if($errors->hasBag('billing') && $errors->getBag('billing')->any()): ?>
        <div style="margin:16px 22px 0; background:rgba(224,85,85,.08); border:1px solid rgba(224,85,85,.25); color:var(--danger); padding:12px 16px; border-radius:9px; font-size:13px;">
            <div style="font-weight:700; margin-bottom:4px;"><i class="fas fa-triangle-exclamation"></i> Please fix:</div>
            <?php $__currentLoopData = $errors->getBag('billing')->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="font-size:12px;">• <?php echo e($err); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php endif; ?>
        ...
        <div style="overflow-x:auto;">
            <table class="data-table" id="tblBilling">
                ...
                <tbody id="blTbody">
                    <?php $__empty_1 = true; $__currentLoopData = $billingRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        $blDate = $bill->booking ? \Carbon\Carbon::parse($bill->booking->booking_date)->format('Y-m-d') : '0000-00-00';
                    ?>
                    <tr class="bl-row"
                        data-ref="<?php echo e($bill->bus_booking_id); ?>"
                        data-date="<?php echo e($blDate); ?>"
                        data-bus="<?php echo e(strtolower($bill->booking->bus_number ?? '')); ?>"
                        data-route="<?php echo e(strtolower(($bill->booking->route_from ?? '') . ' ' . ($bill->booking->route_to ?? ''))); ?>"
                        data-driver="<?php echo e(strtolower($bill->driver_name ?? '')); ?>"
                        data-bookingamt="<?php echo e($bill->booking->booking_amount ?? 0); ?>"
                        data-expenses="<?php echo e($bill->total_expenses); ?>"
                        data-profit="<?php echo e($bill->net_profit ?? 0); ?>">
                        <td class="bl-num" style="color:var(--text-muted); font-weight:700;"><?php echo e($i + 1); ?></td>
                        <td>
                            <span style="background:rgba(30,48,82,.08); color:var(--navy-mid); padding:3px 10px; border-radius:6px; font-size:12px; font-weight:700;">
                                #BK-<?php echo e(str_pad($bill->bus_booking_id, 4, '0', STR_PAD_LEFT)); ?>

                            </span>
                        </td>
                        <td>
                            <div style="display:flex; align-items:center; gap:5px; font-size:13px;">
                                <span style="font-weight:600; color:var(--navy);"><?php echo e($bill->booking->route_from ?? '—'); ?></span>
                                <i class="fas fa-arrow-right" style="color:var(--gold); font-size:10px;"></i>
                                <span style="font-weight:600; color:var(--navy);"><?php echo e($bill->booking->route_to ?? '—'); ?></span>
                            </div>
                        </td>
                        <td><span style="background:rgba(30,48,82,.08); color:var(--navy-mid); padding:3px 9px; border-radius:6px; font-size:12px; font-weight:700;"><?php echo e($bill->booking->bus_number ?? '—'); ?></span></td>
                        <td style="font-size:12px; color:var(--text-muted); white-space:nowrap;">
                            <?php if($bill->booking): ?> <?php echo e(\Carbon\Carbon::parse($bill->booking->booking_date)->format('d M Y')); ?> <?php else: ?> — <?php endif; ?>
                        </td>
                        <td style="font-size:12.5px;">
                            <?php if($bill->driver_name): ?>
                                <div style="font-weight:600;"><?php echo e($bill->driver_name); ?></div>
                                <?php if($bill->driver_mobile): ?><div style="font-size:11px; color:var(--text-muted);"><?php echo e($bill->driver_mobile); ?></div><?php endif; ?>
                            <?php else: ?>
                                <span style="color:var(--text-muted); font-style:italic;">Not set</span>
                            <?php endif; ?>
                        </td>
                        <td style="font-weight:700; color:var(--navy); text-align:right;">₹<?php echo e(number_format($bill->booking->booking_amount ?? 0, 2)); ?></td>
                        <td style="font-weight:700; color:var(--danger); text-align:right;">₹<?php echo e(number_format($bill->total_expenses, 2)); ?></td>
                        <td style="font-weight:800; text-align:right; color:<?php echo e(($bill->net_profit ?? 0) >= 0 ? 'var(--success)' : 'var(--danger)'); ?>;">₹<?php echo e(number_format($bill->net_profit ?? 0, 2)); ?></td>
                        <td>
                            <div style="display:flex; gap:5px; flex-wrap:nowrap;">
                                <a href="<?php echo e(route('manager.billing.pdf', $bill->id)); ?>" target="_blank"
                                   class="action-btn"
                                ...
                                <a href="<?php echo e(route('manager.billing.print', $bill->id)); ?>" target="_blank"
                                   class="action-btn"
                                ...
                                <button class="action-btn btn-edit" title="Edit"
                                    onclick="openEditBillingModal(
                                        <?php echo e($bill->id); ?>,
                                        <?php echo e($bill->bus_booking_id); ?>,
                                        '<?php echo e($bill->rate_per_km ?? ''); ?>',
                                        '<?php echo e($bill->diesel_amount ?? ''); ?>',
                                        '<?php echo e($bill->toll_parking ?? ''); ?>',
                                        '<?php echo e($bill->online_permit ?? ''); ?>',
                                        '<?php echo e($bill->driver_amount ?? ''); ?>',
                                        '<?php echo e($bill->other_expenses ?? ''); ?>',
                                        <?php echo e(json_encode($bill->driver_name ?? '')); ?>,
                                        <?php echo e(json_encode($bill->driver_mobile ?? '')); ?>,
                                        <?php echo e(json_encode($bill->description ?? '')); ?>

                                    )">
                                    <i class="fas fa-pen-to-square"></i>
                                </button>
                                <form action="<?php echo e(route('manager.billing.destroy', $bill->id)); ?>" method="POST" style="margin:0;"
                                    onsubmit="return confirm('Delete billing record #<?php echo e($bill->id); ?>?')">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="action-btn btn-delete" title="Delete"><i class="fas fa-trash"></i></button>
                                </form>
                            </div>
        ...
        <?php if($billingRecords instanceof \Illuminate\Pagination\LengthAwarePaginator && $billingRecords->hasPages()): ?>
        <div class="panel-footer"><?php echo e($billingRecords->links()); ?></div>
        <?php endif; ?>
    </div>
</div>
...
<div id="section-mod-insurance" class="section-content" style="display:none;">
    ...
    <div style="margin-bottom:14px; background:rgba(8,145,178,.1); border:1px solid rgba(8,145,178,.3); color:#0e7490; padding:12px 18px; border-radius:10px; font-size:13px; display:flex; align-items:center; gap:8px;">
        <i class="fas fa-circle-check"></i> <?php echo e(session('tax_success')); ?>

    </div>
    <?php endif; ?>
    <?php if(session('insurance_success')): ?>
    <div style="margin-bottom:14px; background:rgba(79,70,229,.1); border:1px solid rgba(79,70,229,.3); color:#3730a3; padding:12px 18px; border-radius:10px; font-size:13px; display:flex; align-items:center; gap:8px;">
        <i class="fas fa-circle-check"></i> <?php echo e(session('insurance_success')); ?>
    ...
    <div class="panel" style="margin-bottom:22px;">
        <div class="panel-header">
            ...
            <div style="display:flex; gap:8px; align-items:center;">
                <span style="background:rgba(8,145,178,.1); color:#0e7490; padding:7px 14px; border-radius:9px; font-size:13px; font-weight:700;">
                    <i class="fas fa-indian-rupee-sign" style="font-size:11px;"></i> <?php echo e(number_format($totalTaxCost ?? 0, 2)); ?> total
                </span>
                <a href="<?php echo e(route('manager.tax.export.pdf')); ?>" target="_blank"
                   style="background:rgba(224,85,85,.1); color:var(--danger); padding:8px 16px; border-radius:9px; font-size:13px; font-weight:600; text-decoration:none; display:inline-flex; align-items:center; gap:6px;">
        ...
        <?php if($errors->hasBag('tax') && $errors->getBag('tax')->any()): ?>
        <div style="margin:14px 22px 0; background:rgba(224,85,85,.08); border:1px solid rgba(224,85,85,.25); color:var(--danger); padding:12px 16px; border-radius:9px; font-size:13px;">
            <div style="font-weight:700; margin-bottom:4px;"><i class="fas fa-triangle-exclamation"></i> Please fix:</div>
            <?php $__currentLoopData = $errors->getBag('tax')->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="font-size:12px;">• <?php echo e($err); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php endif; ?>
        ...
        <div style="overflow-x:auto;">
            <table class="data-table" id="tblTax">
                ...
                <tbody id="taxTbody">
                    <?php $__empty_1 = true; $__currentLoopData = $taxRecords ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $expired = $tax->tax_to->isPast(); ?>
                    <tr class="tax-row"
                        data-taxdate="<?php echo e($tax->tax_date->format('Y-m-d')); ?>"
                        data-bus="<?php echo e(strtolower($tax->bus_number)); ?>"
                        data-taxfrom="<?php echo e($tax->tax_from->format('Y-m-d')); ?>"
                        data-taxto="<?php echo e($tax->tax_to->format('Y-m-d')); ?>"
                        data-amount="<?php echo e($tax->amount); ?>"
                        data-notes="<?php echo e(strtolower($tax->notes ?? '')); ?>">
                        <td class="tax-row-num" style="color:var(--text-muted); font-weight:600;"><?php echo e($i + 1); ?></td>
                        <td style="font-size:13px; white-space:nowrap;">
                            <i class="fas fa-calendar-day" style="color:#0891b2; font-size:11px; margin-right:4px;"></i>
                            <?php echo e($tax->tax_date->format('d M Y')); ?>

                        </td>
                        <td>
                            <span style="background:rgba(30,48,82,.08); color:var(--navy-mid); padding:3px 10px; border-radius:6px; font-size:12px; font-weight:700;">
                                <?php echo e($tax->bus_number); ?>

                            </span>
                        </td>
                        <td style="font-size:12.5px; white-space:nowrap;">
                            <i class="fas fa-calendar-check" style="color:#0891b2; font-size:10px; margin-right:3px;"></i>
                            <?php echo e($tax->tax_from->format('d M Y')); ?>

                        </td>
                        <td style="white-space:nowrap;">
                            <span style="font-size:12.5px; font-weight:600; color:<?php echo e($expired ? 'var(--danger)' : 'var(--success)'); ?>;">
                                <i class="fas fa-<?php echo e($expired ? 'circle-xmark' : 'circle-check'); ?>" style="font-size:10px; margin-right:3px;"></i>
                                <?php echo e($tax->tax_to->format('d M Y')); ?>
                        ...
                        <td style="text-align:center;">
                            <?php if($tax->tax_image): ?>
                                <a href="<?php echo e(Storage::url($tax->tax_image)); ?>" target="_blank"
                        ...
                        <td style="font-weight:700; color:var(--danger); text-align:right;">
                            ₹<?php echo e(number_format($tax->amount, 2)); ?>

                        </td>
                        <td style="font-size:12px; color:var(--text-muted); max-width:140px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;"
                            title="<?php echo e($tax->notes); ?>">
                            <?php echo e($tax->notes ?? '—'); ?>

                        </td>
                        <td>
                            <div style="display:flex; gap:5px;">
                                <a href="<?php echo e(route('manager.tax.pdf', $tax->id)); ?>" target="_blank"
                                   class="action-btn"
                                   style="background:rgba(224,85,85,.1); color:var(--danger); padding:5px 10px; border-radius:7px; font-size:12px; font-weight:600; text-decoration:none; display:inline-flex; align-items:center; gap:4px;"
                                   title="Export PDF"><i class="fas fa-file-pdf"></i>
                                </a>
                                <a href="<?php echo e(route('manager.tax.print', $tax->id)); ?>" target="_blank"
                                   class="action-btn"
                                   style="background:rgba(59,130,246,.1); color:var(--info); padding:5px 10px; border-radius:7px; font-size:12px; font-weight:600; text-decoration:none; display:inline-flex; align-items:center; gap:4px;"
                                   title="Print"><i class="fas fa-print"></i>
                                </a>
                                <button type="button" class="action-btn btn-edit" title="Edit"
                                    onclick="openEditTaxModal(
                                        <?php echo e($tax->id); ?>,
                                        '<?php echo e($tax->tax_date->format('Y-m-d')); ?>',
                                        <?php echo e(json_encode($tax->bus_number)); ?>,
                                        '<?php echo e($tax->tax_from->format('Y-m-d')); ?>',
                                        '<?php echo e($tax->tax_to->format('Y-m-d')); ?>',
                                        <?php echo e($tax->amount); ?>,
                                        <?php echo e(json_encode($tax->notes ?? '')); ?>,
                                        '<?php echo e($tax->tax_image ? Storage::url($tax->tax_image) : ''); ?>'
                                    )">
                                    <i class="fas fa-pen-to-square"></i>
                                </button>
                                <form action="<?php echo e(route('manager.tax.destroy', $tax->id)); ?>" method="POST" style="margin:0;"
                                      onsubmit="return confirm('Delete tax record for <?php echo e($tax->bus_number); ?>?')">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="action-btn btn-delete" title="Delete">
                                        <i class="fas fa-trash"></i>
                                    </button>
    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <div style="display:flex; gap:8px; align-items:center;">
                <span style="background:rgba(79,70,229,.1); color:#3730a3; padding:7px 14px; border-radius:9px; font-size:13px; font-weight:700;">
                    <i class="fas fa-indian-rupee-sign" style="font-size:11px;"></i> <?php echo e(number_format($totalInsuranceCost ?? 0, 2)); ?> total
                </span>
                <a href="<?php echo e(route('manager.insurance.export.pdf')); ?>" target="_blank"
                   style="background:rgba(224,85,85,.1); color:var(--danger); padding:8px 16px; border-radius:9px; font-size:13px; font-weight:600; text-decoration:none; display:inline-flex; align-items:center; gap:6px;">
                    <i class="fas fa-file-pdf"></i> Export All PDF
                </a>
        ...
        <?php if($errors->hasBag('insurance') && $errors->getBag('insurance')->any()): ?>
        <div style="margin:14px 22px 0; background:rgba(224,85,85,.08); border:1px solid rgba(224,85,85,.25); color:var(--danger); padding:12px 16px; border-radius:9px; font-size:13px;">
            <div style="font-weight:700; margin-bottom:4px;"><i class="fas fa-triangle-exclamation"></i> Please fix:</div>
            <?php $__currentLoopData = $errors->getBag('insurance')->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="font-size:12px;">• <?php echo e($err); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php endif; ?>
        ...
        <div style="overflow-x:auto;">
            <table class="data-table" id="tblInsurance">
                ...
                <tbody id="insTbody">
                    <?php $__empty_1 = true; $__currentLoopData = $insuranceRecords ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ins): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="ins-row"
                        data-insdate="<?php echo e($ins->insurance_date->format('Y-m-d')); ?>"
                        data-bus="<?php echo e(strtolower($ins->bus_number)); ?>"
                        data-amount="<?php echo e($ins->amount); ?>"
                        data-notes="<?php echo e(strtolower($ins->notes ?? '')); ?>">
                        <td class="ins-row-num" style="color:var(--text-muted); font-weight:600;"><?php echo e($i + 1); ?></td>
                        <td style="font-size:13px; white-space:nowrap;">
                            <i class="fas fa-calendar-day" style="color:#4f46e5; font-size:11px; margin-right:4px;"></i>
                            <?php echo e($ins->insurance_date->format('d M Y')); ?>

                        </td>
                        <td>
                            <span style="background:rgba(30,48,82,.08); color:var(--navy-mid); padding:3px 10px; border-radius:6px; font-size:12px; font-weight:700;">
                                <?php echo e($ins->bus_number); ?>

                            </span>
                        </td>
                        <td style="font-weight:700; color:var(--danger); text-align:right;">
                            ₹<?php echo e(number_format($ins->amount, 2)); ?>

                        </td>
                        <td style="font-size:12px; color:var(--text-muted); max-width:200px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;"
                            title="<?php echo e($ins->notes); ?>">
                            <?php echo e($ins->notes ?? '—'); ?>

                        </td>
                        <td>
                            <div style="display:flex; gap:5px;">
                                <a href="<?php echo e(route('manager.insurance.pdf', $ins->id)); ?>" target="_blank"
                                   class="action-btn"
                                   style="background:rgba(224,85,85,.1); color:var(--danger); padding:5px 10px; border-radius:7px; font-size:12px; font-weight:600; text-decoration:none; display:inline-flex; align-items:center; gap:4px;"
                                   title="Export PDF"><i class="fas fa-file-pdf"></i>
                                </a>
                                <a href="<?php echo e(route('manager.insurance.print', $ins->id)); ?>" target="_blank"
                                   class="action-btn"
                                   style="background:rgba(59,130,246,.1); color:var(--info); padding:5px 10px; border-radius:7px; font-size:12px; font-weight:600; text-decoration:none; display:inline-flex; align-items:center; gap:4px;"
                                   title="Print"><i class="fas fa-print"></i>
                                </a>
                                <button type="button" class="action-btn btn-edit" title="Edit"
                                    onclick="openEditInsuranceModal(
                                        <?php echo e($ins->id); ?>,
                                        '<?php echo e($ins->insurance_date->format('Y-m-d')); ?>',
                                        <?php echo e(json_encode($ins->bus_number)); ?>,
                                        <?php echo e($ins->amount); ?>,
                                        <?php echo e(json_encode($ins->notes ?? '')); ?>

                                    )">
                                    <i class="fas fa-pen-to-square"></i>
                                </button>
                                <form action="<?php echo e(route('manager.insurance.destroy', $ins->id)); ?>" method="POST" style="margin:0;"
                                      onsubmit="return confirm('Delete insurance record for <?php echo e($ins->bus_number); ?>?')">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="action-btn btn-delete" title="Delete">
                                        <i class="fas fa-trash"></i>
                                    </button>
...
<div id="section-mod-reports" class="section-content" style="display:none;">
    <div class="panel" style="margin-bottom:22px;">
        <div class="panel-header">
            ...
            <a href="<?php echo e(route('travels.export')); ?>" class="btn-primary">
        ...
        <div class="panel-body">
            <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:16px; margin-bottom:24px;">
                <div style="background:#f6f8fb; border-radius:12px; padding:18px; text-align:center;">
                    <div style="font-size:28px; font-weight:800; color:var(--navy); font-family:'Playfair Display',serif;"><?php echo e($totalEnquiries); ?></div>
                    <div style="font-size:12px; color:var(--text-muted); margin-top:4px;">Total Enquiries</div>
                </div>
                <div style="background:#f6f8fb; border-radius:12px; padding:18px; text-align:center;">
                    <div style="font-size:28px; font-weight:800; color:var(--warning); font-family:'Playfair Display',serif;"><?php echo e($pendingCount); ?></div>
                    <div style="font-size:12px; color:var(--text-muted); margin-top:4px;">Pending</div>
                </div>
                <div style="background:#f6f8fb; border-radius:12px; padding:18px; text-align:center;">
                    <div style="font-size:28px; font-weight:800; color:var(--success); font-family:'Playfair Display',serif;"><?php echo e($resolvedCount); ?></div>
                    <div style="font-size:12px; color:var(--text-muted); margin-top:4px;">Approved</div>
                </div>
                <div style="background:#f6f8fb; border-radius:12px; padding:18px; text-align:center;">
                    <div style="font-size:28px; font-weight:800; color:var(--gold); font-family:'Playfair Display',serif;"><?php echo e($todayCount); ?></div>
            ...
            ?>
            <?php $__currentLoopData = $rptData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $count, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $pct = $totalEnquiries ? round($count/$totalEnquiries*100) : 0; ?>
            <div style="margin-bottom:14px;">
                <div style="display:flex; justify-content:space-between; font-size:13px; font-weight:500; color:#374151; margin-bottom:5px;">
                    ...
                    <span style="color:var(--text-muted);"><?php echo e($count); ?> (<?php echo e($pct); ?>%)</span>
                </div>
                <div class="progress-bar">
                    <div class="progress-fill" style="width:<?php echo e($pct); ?>%; background:linear-gradient(90deg,<?php echo e($color); ?>,<?php echo e($color); ?>bb);"></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<div class="booking-modal-overlay" id="busBookingModal">
    <div class="booking-modal">
        ...
        <form action="<?php echo e(route('manager.booking.store')); ?>" method="POST" id="busBookingForm" novalidate>
            <?php echo csrf_field(); ?>
                ...
                <div class="bform-grid">
                    ...
                    <div class="bform-group full">
                        ...
                        <input type="date" name="booking_date" id="bookingDate" class="bform-input"
                               ...
                               value="<?php echo e(old('booking_date')); ?>" onchange="validateBookingDate()">
                    ...
                    <div class="bform-group full">
                        ...
                        <div class="route-row">
                            <div>
                                <input type="text" name="route_from" id="routeFrom" class="bform-input" placeholder="Starting point" value="<?php echo e(old('route_from')); ?>" oninput="validateField('routeFrom','err-route_from','Starting point is required.')">
                            ...
                            <div>
                                <input type="text" name="route_to" id="routeTo" class="bform-input" placeholder="Destination" value="<?php echo e(old('route_to')); ?>" oninput="validateField('routeTo','err-route_to','Destination is required.')">
                    ...
                    <div class="bform-group full">
                        ...
                        <input type="text" name="bus_no" id="busNo" class="bform-input" placeholder="e.g. MH12 AB 1234" value="<?php echo e(old('bus_no')); ?>" style="text-transform:uppercase;" oninput="this.value=this.value.toUpperCase(); validateField('busNo','err-bus_no','Bus number is required.')">
                    ...
                    <div class="bform-group">
                        ...
                        <div style="position:relative;">
                            <input type="number" name="kilometer" id="kilometer" class="bform-input" placeholder="Distance in km" min="1" step="0.01" value="<?php echo e(old('kilometer')); ?>" oninput="validateField('kilometer','err-kilometer','Min 1 km.')">
                    ...
                    <div class="bform-group">
                        ...
                        <input type="time" name="pickup_time" id="pickupTime" class="bform-input" value="<?php echo e(old('pickup_time')); ?>" onchange="validatePickupTime()">
                    ...
                    <div class="bform-group">
                        ...
                        <div class="amount-wrap"><span class="amount-prefix">₹</span><input type="number" name="booking_amount" id="bookingAmount" class="bform-input" placeholder="0.00" min="1" step="0.01" value="<?php echo e(old('booking_amount')); ?>" oninput="validateAmounts()"></div>
                    ...
                    <div class="bform-group">
                        ...
                        <div class="amount-wrap"><span class="amount-prefix">₹</span><input type="number" name="advance_amount" id="advanceAmount" class="bform-input" placeholder="0.00" min="0" step="0.01" value="<?php echo e(old('advance_amount')); ?>" oninput="validateAmounts()"></div>
                    ...
                    <div class="bform-group full">
                        ...
                        <textarea name="note" class="bform-input" rows="2" placeholder="Additional notes…" style="resize:vertical; min-height:60px;"><?php echo e(old('note')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="booking-modal-body">
                <div class="bform-grid">
                    ...
                    <div class="bform-group full">
                        ...
                        <input type="date" name="booking_date" id="editBookingDate" class="bform-input" min="<?php echo e(\Carbon\Carbon::tomorrow()->format('Y-m-d')); ?>" onchange="validateEditDate()">
...
<div class="maint-modal-overlay" id="maintModal">
    <div class="maint-modal">
        ...
        <form action="<?php echo e(route('manager.maintenance.store')); ?>" method="POST" id="maintForm"
                ...
                <div class="mmod-grid">
                    ...
                    <div class="mmod-group">
                        ...
                        <input type="date" name="maintenance_date" id="maintDate" class="mmod-input"
                               value="<?php echo e(old('maintenance_date')); ?>" required>
                    ...
                    <div class="mmod-group">
                        ...
                        <input type="text" name="bus_number" id="maintBusNo" class="mmod-input"
                               ...
                               value="<?php echo e(old('bus_number')); ?>"
                    ...
                    <div class="mmod-group mmod-full">
                        ...
                        <select name="maintenance_type" id="maintType" class="mmod-input"
                            ...
                            <option value="Oil Change"          <?php echo e(old('maintenance_type')==='Oil Change'          ? 'selected':''); ?>>Oil Change</option>
                            <option value="Tyre Replacement"    <?php echo e(old('maintenance_type')==='Tyre Replacement'    ? 'selected':''); ?>>Tyre Replacement</option>
                            <option value="Engine Repair"       <?php echo e(old('maintenance_type')==='Engine Repair'       ? 'selected':''); ?>>Engine Repair</option>
                            <option value="Brake Service"       <?php echo e(old('maintenance_type')==='Brake Service'       ? 'selected':''); ?>>Brake Service</option>
                            <option value="Battery Replacement" <?php echo e(old('maintenance_type')==='Battery Replacement' ? 'selected':''); ?>>Battery Replacement</option>
                            <option value="AC Service"          <?php echo e(old('maintenance_type')==='AC Service'          ? 'selected':''); ?>>AC Service</option>
                            <option value="General Service"     <?php echo e(old('maintenance_type')==='General Service'     ? 'selected':''); ?>>General Service</option>
                            <option value="Body Work"           <?php echo e(old('maintenance_type')==='Body Work'           ? 'selected':''); ?>>Body Work</option>
                            <option value="Electrical Repair"   <?php echo e(old('maintenance_type')==='Electrical Repair'   ? 'selected':''); ?>>Electrical Repair</option>
                            <option value="Wheel Alignment"     <?php echo e(old('maintenance_type')==='Wheel Alignment'     ? 'selected':''); ?>>Wheel Alignment</option>
                            <option value="Other"               <?php echo e(old('maintenance_type')==='Other'               ? 'selected':''); ?>>Other (specify below)</option>
                        </select>
                    ...
                    <div class="mmod-group mmod-full" id="maintCustomTypeWrap"
                         style="display:<?php echo e(old('maintenance_type')==='Other' ? 'flex' : 'none'); ?>; flex-direction:column; gap:5px;">
                        ...
                        <input type="text" name="custom_type" id="maintCustomType" class="mmod-input"
                               ...
                               value="<?php echo e(old('custom_type')); ?>">
                    ...
                    <div class="mmod-group">
                        ...
                        <div class="mmod-prefix-wrap">
                            ...
                            <input type="number" name="amount_paid" id="maintAmount" class="mmod-input"
                                   ...
                                   value="<?php echo e(old('amount_paid')); ?>" required>
                        </div>
                    ...
                    <div class="mmod-group mmod-full">
                        ...
                        <textarea name="description" class="mmod-input" rows="3"
                                  ...
                                  placeholder="Any additional details about the maintenance…"><?php echo e(old('description')); ?></textarea>
                    </div>
...
<div class="billing-modal-overlay" id="billingModal">
    <div class="billing-modal">
        ...
        <form action="<?php echo e(route('manager.billing.store')); ?>" method="POST" id="billingForm" novalidate>
            <?php echo csrf_field(); ?>
            <div class="billing-modal-body">
                ...
                <div class="bmod-group" style="margin-bottom:4px;">
                    ...
                    <select name="bus_booking_id" id="billingBookingId" class="bmod-input" onchange="updateBillingBookingInfo(this)">
                        ...
                        <?php $__currentLoopData = $busBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($bk->id); ?>"
                            data-amount="<?php echo e($bk->booking_amount); ?>"
                            data-route="<?php echo e($bk->route_from); ?> → <?php echo e($bk->route_to); ?>"
                            data-km="<?php echo e($bk->kilometer); ?>">
                            #BK-<?php echo e(str_pad($bk->id,4,'0',STR_PAD_LEFT)); ?> — <?php echo e($bk->route_from); ?> → <?php echo e($bk->route_to); ?>

                            (<?php echo e(\Carbon\Carbon::parse($bk->booking_date)->format('d M Y')); ?>)
                        </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
<script>
const enquiriesData = <?php echo json_encode($allEnquiries->getCollection()->keyBy('id'), 15, 512) ?>;
...
// ── TOAST ──
<?php if(session('manager_success')): ?>
window.addEventListener('load', () => {
    const t = document.getElementById('toast');
    document.getElementById('toastMsg').textContent = <?php echo json_encode(session('manager_success'), 15, 512) ?>;
...
function openBookingModal() {
    ...
    <?php if($errors->hasBag('booking')): ?>
        setTimeout(() => {
            <?php $__currentLoopData = ['booking_date','route_from','route_to','bus_no','kilometer','pickup_time','booking_amount','advance_amount']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($errors->getBag('booking')->has($field)): ?>
            showFieldError('<?php echo e($field); ?>', '<?php echo e($errors->getBag("booking")->first($field)); ?>');
            <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            updateSummary();
        }, 100);
...
<?php if($errors->hasBag('booking') && $errors->getBag('booking')->any()): ?>
window.addEventListener('load', () => {
...
window.addEventListener('load', () => {
    showSection('mod-booking', document.querySelector('[data-section=mod-booking]'));
    const t = document.getElementById('toast');
    document.getElementById('toastMsg').textContent = <?php echo json_encode(session('booking_success'), 15, 512) ?>;
...
<?php if($errors->hasBag('editBooking') && $errors->getBag('editBooking')->any()): ?>
...
window.addEventListener('load', () => {
    ...
    const t = document.getElementById('toast');
    document.getElementById('toastMsg').textContent = <?php echo json_encode(session('maintenance_success'), 15, 512) ?>;
...
<?php endif; ?>
<?php if($errors->hasBag('editMaintenance') && $errors->getBag('editMaintenance')->any()): ?>
...
const bookingAmounts = {
    <?php $__currentLoopData = $busBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo e($bk->id); ?>: { amount: <?php echo e($bk->booking_amount); ?>, route: "<?php echo e($bk->route_from); ?> → <?php echo e($bk->route_to); ?>", km: <?php echo e($bk->kilometer); ?> },
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
};
...
<?php if($errors->hasBag('editBilling') && $errors->getBag('editBilling')->any()): ?>
...
window.addEventListener('load', () => {
    ...
    const t = document.getElementById('toast');
    document.getElementById('toastMsg').textContent = <?php echo json_encode(session('billing_success'), 15, 512) ?>;
    t.style.background = '#1a4731';
...
<?php if($errors->hasBag('tax') || $errors->hasBag('editTax') || session('tax_success') || $errors->hasBag('insurance') || $errors->hasBag('editInsurance') || session('insurance_success')): ?>
window.addEventListener('load', () => {
...
<div class="ins-modal-overlay" id="taxModal">
    <div class="ins-modal">
        ...
        <form action="<?php echo e(route('manager.tax.store')); ?>" method="POST"
              enctype="multipart/form-data" novalidate>
            <?php echo csrf_field(); ?>
                ...
                <div class="imod-grid">
                    ...
                    <div class="imod-group">
                        ...
                        <input type="date" name="tax_date" class="imod-input tax-input"
                               value="<?php echo e(old('tax_date', date('Y-m-d'))); ?>" required>
                    </div>
                    ...
                    <div class="imod-group">
                        ...
                        <input type="text" name="bus_number" class="imod-input tax-input"
                               ...
                               value="<?php echo e(old('bus_number')); ?>" required>
                    </div>
                    ...
                    <div class="imod-group">
                        ...
                        <input type="date" name="tax_from" id="taxFromDate"
                               ...
                               value="<?php echo e(old('tax_from')); ?>" required
                    ...
                    <div class="imod-group">
                        ...
                        <input type="date" name="tax_to" id="taxToDate"
                               class="imod-input tax-input"
                               value="<?php echo e(old('tax_to')); ?>" required>
...
<div class="ins-modal-overlay" id="insuranceModal">
    <div class="ins-modal">
        ...
        <form action="<?php echo e(route('manager.insurance.store')); ?>" method="POST" novalidate>
            <?php echo csrf_field(); ?>
            <div class="ins-modal-body">
                <div class="imod-grid">
                    ...
                    <div class="imod-group">
                        ...
                        <input type="date" name="insurance_date" class="imod-input ins-input"
                               value="<?php echo e(old('insurance_date', date('Y-m-d'))); ?>" required>
                    </div>
                    ...
                    <div class="imod-group imod-full">
                        ...
                        <textarea name="notes" class="imod-input ins-input" rows="2"
                                  style="resize:vertical;"
                                  placeholder="Policy number, insurer name, coverage details…"><?php echo e(old('notes')); ?></textarea>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\travels_management\resources\views/manager/dashboard.blade.php ENDPATH**/ ?>