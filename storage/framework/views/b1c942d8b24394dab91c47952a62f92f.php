...
<head>
    <meta charset="UTF-8">
    <title><?php echo $__env->yieldContent('title', 'Venkatesh Tours & Travels'); ?></title>
...
<nav id="mainNav" class="navbar navbar-expand-lg navbar-dark fixed-top <?php echo $__env->yieldContent('nav-bg', 'bg-transparent'); ?>">
    <div class="container">
        <a class="navbar-brand" href="<?php echo e(route('welcome')); ?>">Venkatesh Tours &amp; Travels</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
                <li class="nav-item">
                    <a class="nav-link <?php echo $__env->yieldContent('nav-home'); ?>" href="<?php echo e(route('welcome')); ?>">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $__env->yieldContent('nav-about'); ?>" href="<?php echo e(route('about')); ?>">About Us</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $__env->yieldContent('nav-gallery'); ?>" href="<?php echo e(route('gallery')); ?>">Gallery</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $__env->yieldContent('nav-contact'); ?>" href="<?php echo e(route('contact')); ?>">Contact Us</a>
                </li>
                ...
                <?php if(auth()->guard()->guest()): ?>
                    ...
                    <li class="nav-item ms-lg-2">
                        <a class="nav-link d-flex align-items-center gap-1" href="<?php echo e(route('login')); ?>" title="Login">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <li class="nav-item ms-lg-2">
                        <a class="nav-link d-flex align-items-center gap-1" href="<?php echo e(route('dashboard')); ?>">
        ...
        <div class="row g-4 pb-4">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul style="list-style:none;padding:0;margin:0;font-size:14px;line-height:2.4;">
                    <li><a class="footer-link" href="<?php echo e(route('welcome')); ?>"><i class="bi bi-chevron-right text-warning" style="font-size:11px;"></i> Home</a></li>
                    <li><a class="footer-link" href="<?php echo e(route('about')); ?>"><i class="bi bi-chevron-right text-warning" style="font-size:11px;"></i> About Us</a></li>
                    <li><a class="footer-link" href="<?php echo e(route('gallery')); ?>"><i class="bi bi-chevron-right text-warning" style="font-size:11px;"></i> Gallery</a></li>
                    <li><a class="footer-link" href="<?php echo e(route('contact')); ?>"><i class="bi bi-chevron-right text-warning" style="font-size:11px;"></i> Contact Us</a></li>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul style="list-style:none;padding:0;margin:0;font-size:14px;line-height:2.4;">
                    <li><a class="footer-link" href="<?php echo e(route('welcome')); ?>#services"><i class="bi bi-chevron-right text-warning" style="font-size:11px;"></i> Seater Bus Booking</a></li>
                    <li><a class="footer-link" href="<?php echo e(route('welcome')); ?>#services"><i class="bi bi-chevron-right text-warning" style="font-size:11px;"></i> Sleeper Bus Booking</a></li>
                    <li><a class="footer-link" href="<?php echo e(route('welcome')); ?>#services"><i class="bi bi-chevron-right text-warning" style="font-size:11px;"></i> Tours Packages</a></li>
                    <li><a class="footer-link" href="<?php echo e(route('welcome')); ?>#services"><i class="bi bi-chevron-right text-warning" style="font-size:11px;"></i> Bus Rental</a></li>
                    <li><a class="footer-link" href="<?php echo e(route('welcome')); ?>#services"><i class="bi bi-chevron-right text-warning" style="font-size:11px;"></i> Marriage Booking</a></li>
                </ul>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\travels_management\resources\views/layouts/public.blade.php ENDPATH**/ ?>